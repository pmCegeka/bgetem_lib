export class ContactCard {
    constructor({ title, description, link1, link2 }) {
        this.title = title;
    ...
    render() {
        ...
        container.className = "postfach-card";

        container.innerHTML = `
      
    <div class="contact-card" role="region" aria-labelledby="postfach-title">
        ...
        <div class="contact-card-title" id="postfach-title">${this.title}</div>
    </div>
    <div class="contact-card-content">
       ${this.description}
      </div>
        <div class="contact-card-actions">
            <a href="#" role="link">${this.link1}</a>
            <a href="#" role="link">${this.link2}</a>
        </div>
    </div>
    `;
        return container;
